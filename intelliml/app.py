...
# Add parent directory (project root) to path so intelliml package can be imported
...
# ─── Import ML engine ─────────────────────────────────────────────────────────
# Handle imports from nested intelliml package
# Add the current directory (intelliml) to path so we can import from ./intelliml
...
try:
    ...
    st.error(f"Failed to import ML engine: {e}")
    st.stop()
